"""
Django settings for fragrant_sound_42915 project.
...
ROOT_URLCONF = 'fragrant_sound_42915.urls'
...
WSGI_APPLICATION = 'fragrant_sound_42915.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_sound_42915 API",
    "DESCRIPTION": "API documentation for fragrant_sound_42915 App",
    "VERSION": "v1",
}
